...
bool solveSudoku (int mat[][9],int i,int j,int n)  // we will stop backtracking once we found out the right solution 
{
    // base case 
    if(i==n)
    {
    ...
    {
        //whether it is safe to place the number or not by looking at the row 
